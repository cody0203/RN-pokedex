...
import { View, StyleSheet, FlatList, ActivityIndicator, Dimensions, TouchableOpacity } from 'react-native';
...
const PokemonListScreen = ({ navigation }) => {
    // REDUX DATA
    const { pokemonListData, pokemonListLoading, pokemonListMeta } = useSelector((store) =>
        get(store, 'pokemonReducer.pokemonList')
    );
